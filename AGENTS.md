# Agent Instructions for mammos-spindynamics
...
If this checkout is located at `mammos-devtools/packages/mammos-spindynamics`,
also read `../../AGENTS.md` for umbrella-repository guidance.
